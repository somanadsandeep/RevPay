...
public class BusinessAnalyticsServiceImpl implements BusinessAnalyticsService {
    private static final Logger logger =
            LogManager.getLogger(BusinessAnalyticsServiceImpl.class);
    ...
    public void showOutstandingInvoices(int businessId) {
        ...
        try {
            ...
            String sql =
                    ...
                    "NVL(SUM(amount),0) AS pending_amount " +
            ...
            if (rs.next()) {
                ...
                logger.info("Outstanding invoices fetched | businessId={} count={} amount={}",
    ...
    public void showPaymentTrends(int businessId) {
        ...
        try {
            ...
            while (rs.next()) {
                logger.info("Payment trend | businessId={} status={} count={}",
                        businessId,
                        rs.getString("status"),
                        rs.getInt("count"));
            }
    ...
    public void showTopCustomers(int businessId) {
        ...
        try {
            ...
            String sql =
                    "SELECT sender_id, NVL(SUM(amount),0) AS total_paid " +
                    "FROM payment_transactions " +
                    "WHERE receiver_id=? " +
                    "GROUP BY sender_id " +
            ...
            while (rs.next() && rowCount < 5) { // emulate LIMIT 5
                logger.info("Top customer | businessId={} customerId={} totalPaid={}",
                        businessId,
                        rs.getInt("sender_id"),
