...
public class WalletServiceImpl implements WalletService {
    private static final Logger logger =
            LogManager.getLogger(WalletServiceImpl.class);
    ...
    public void deposit(int userId, double amount) {
        ...
        try {
            ...
            String updateSql =
                    "UPDATE user_wallet SET balance = balance + ?, last_updated = SYSTIMESTAMP WHERE user_id=?";
    ...
    public void withdraw(int userId, double amount) {
        ...
        try {
            ...
            if (balance < amount) {
                logger.warn("Insufficient balance | userId={} balance={} requested={}",
            ...
            logger.info("Withdrawal successful | userId={} amount={} remainingBalance={}",
