...
public class InvoiceServiceImpl implements InvoiceService {
	...
	public void createInvoice(int businessId, String customerEmail, String items, double amount, String paymentTerms)
			throws Exception {

		Connection con = DBConfig.getConnection();

		String sql = "INSERT INTO business_invoices "
				+ "(business_id, customer_email, items, amount, payment_terms, status) " + "VALUES (?, ?, ?, ?, ?, ?)";
	...
	public void markInvoicePaid(int invoiceId) throws Exception {
		...
		String sql = "UPDATE business_invoices SET status='PAID' WHERE invoice_id=?";
	...
	public void markInvoiceUnpaid(int invoiceId) throws Exception {
		...
		String sql = "UPDATE business_invoices SET status='UNPAID' WHERE invoice_id=?";
	...
	public void viewInvoices(int businessId) throws Exception {
		...
		String sql = "SELECT invoice_id, customer_email, amount, status " + "FROM business_invoices "
				+ "WHERE business_id=? " + "ORDER BY invoice_id DESC";
		...
		while (rs.next()) {
			found = true;
			System.out
					.println("Invoice ID: " + rs.getInt("invoice_id") + " | Customer: " + rs.getString("customer_email")
