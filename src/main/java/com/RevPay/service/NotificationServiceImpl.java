...
public class NotificationServiceImpl implements NotificationService {
	...
	public void notifyUser(int userId, String message) {
		...
		try {
			...
			String sql = "INSERT INTO user_notifications (user_id, message, is_read) " + "VALUES (?,?,?)";
	...
	public void viewNotifications(int userId) {
		...
		try {
			...
			while (rs.next()) {
				...
				logger.info("Notification | id={} message={} read={}", rs.getInt("id"), rs.getString("message"),
	...
	public void viewUnreadNotifications(int userId) {
		...
		try {
			...
			String sql = "SELECT * FROM user_notifications " + "WHERE user_id=? AND is_read='N'";
			...
			while (rs.next()) {
				...
				logger.info("Unread notification | id={} message={}", rs.getInt("id"), rs.getString("message"));
			}
